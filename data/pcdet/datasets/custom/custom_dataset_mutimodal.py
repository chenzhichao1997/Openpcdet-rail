...
if __name__ == '__main__':
    ...
    dataset_cfg = EasyDict(yaml.safe_load(open('/home/G9120130136/userdata/czc/OpenPCDet-master/tools/cfgs_mutimodal/dataset_cfgs/mutimodel.yaml')))
    ROOT_DIR = '/home/G9120130136/userdata/czc/OpenPCDet-master'
    create_custom_infos(
            dataset_cfg=dataset_cfg,
            class_names=['Bus', 'Car', 'Van','Pedestrian','Truck','Unknown'],
