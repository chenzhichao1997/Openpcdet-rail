...
from pcdet.models.model_utils_copy.hednet_utils import post_act_block_sparse_3d
from pcdet.models.model_utils_copy.hednet_utils import post_act_block_sparse_2d
from pcdet.models.model_utils_copy.hednet_utils import post_act_block_dense_2d
from pcdet.models.model_utils_copy.hednet_utils import SparseBasicBlock3D
from pcdet.models.model_utils_copy.hednet_utils import SparseBasicBlock2D
from pcdet.models.model_utils_copy.hednet_utils import BasicBlock
...
class SparseHEDNet2D(SparseHEDNet):
    ...
    def __init__(self, model_cfg, input_channels, grid_size, class_names=["road_vehicle","person","buffer_stop","train"], **kwargs):
        kwargs['xy_only'] = True
        super().__init__(model_cfg, input_channels, grid_size, class_names, **kwargs)
