...
from ..model_utils_copy.transfusion_utils import PositionEmbeddingLearned
from ..model_utils_copy.transfusion_utils import TransformerDecoderLayer
...
class SparseTransFusionHead(nn.Module):
    ...
    def loss(self, gt_bboxes_3d, gt_labels_3d, pred_dicts, **kwargs):
        ...
        # regression loss
        preds = torch.cat([pred_dicts[head_name] for head_name in ['center', 'height', 'dim', 'rot']], dim=1).permute(0, 2, 1)
