...
from .RailFastVoxelNet import RailFastVoxelNet
from .TFusion import TFusion
from .TFusion_Sparse import TFusion_Sparse
...
__all__ = {
    ...
    'BevFusion': BevFusion,
    'RailFastVoxelNet':RailFastVoxelNet,
    'TFusion':TFusion,
    'TFusion_Sparse':TFusion_Sparse,
