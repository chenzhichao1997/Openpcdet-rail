...
from ..model_utils_copy import centernet_utils
from ..model_utils_copy import model_nms_utils
...
class VoxelNeXtHead_ours(nn.Module):
    ...
    def assign_targets(self, gt_boxes, num_voxels, spatial_indices, spatial_shape):
        ...
        for idx, cur_class_names in enumerate(self.class_names_each_head):
            ...
            for bs_idx in range(batch_size):
                cur_gt_boxes = gt_boxes[bs_idx] #获得1个batch size的gt_boxes
    ...
    def get_loss(self):
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            hm_loss *= self.model_cfg.LOSS_CONFIG.LOSS_WEIGHTS['cls_weight']#这是热图分类损失
    ...
    def _get_voxel_infos(self, x):
        ...
        for bs_idx in range(batch_size):
            ...
            t = voxel_indices[batch_inds][:, [2, 1]]
            spatial_indices.append(t)
            num_voxels.append(batch_inds.sum())
        #spatial_indices.append(voxel_indices[:, [2, 1]])
        #num_voxels.append(len(spatial_indices))
