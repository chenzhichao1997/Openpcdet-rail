...
def create_custom_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    custom_infos_val = dataset.get_infos(
        class_names=class_names, num_workers=workers, has_label=True, num_features=num_features
    )
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        #     class_names=["person", "signal", "train", "buffer_stop", "road_vehicle", "catenary_pole"],
        #     data_path=ROOT_DIR / 'data' / 'custom',
        #     save_path=ROOT_DIR / 'data' / 'custom',
        # )
        #["Car","Pedestrian","Bicycle","Van","Bus","Truck"],
        create_custom_infos(
            dataset_cfg=dataset_cfg,
